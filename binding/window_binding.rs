...
use magnus::{define_module, method, Module, define_class, Object, function, Value};

use crate::{viewport::{ViewportType, Viewport}, get_graphics};
...
pub fn bind() -> Result<(), magnus::Error> {
	let module = define_module("Window")?;
